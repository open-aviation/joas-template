...
% !!!!!! important guideline for authors !!!!!!

% 1. Put all content in the main.tex. Do NOT use \input{} or \include{} commands to include other files.
% 2. All figures must be placed in the "figures" folder, no spaces in figures file names
% 3. Do not rename folder or file names, to facilitate the copyediting automation process, including: "main.tex", "/figures" folder, "reference.bib"
% 4. Use vanilla table and tabular environment, otherwise your tables will not be generated properly in web version
% 5. Do not use subfloat package, otherwise your figures will not be generated properly in web version. Use subfigure package instead.
...
Place all content in \texttt{main.tex}. Do NOT use \verb|\input{}| or \verb|\include{}| to add external \verb|.tex| files.
