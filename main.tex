...
% 1. Put all content in the main.tex. \textcolor{red}{DO NOT} use \input{} or \include{} commands to include other files.
% 2. All figures must be placed in the "figures" folder, no spaces in figures file names
% 3. \textcolor{red}{DO not} rename folder or file names, to facilitate the copyediting automation process, including: "main.tex", "/figures" folder, "reference.bib"
% 4. Use vanilla table and tabular environment, otherwise your tables will not be generated properly in web version
% 5. \textcolor{red}{DO not} use subfloat package, otherwise your figures will not be generated properly in web version. Use subfigure package instead.
